package com.ironhack.week9tuesday.security;

import com.ironhack.week9tuesday.security.filters.CustomAuthenticationFilter;
import com.ironhack.week9tuesday.security.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(POST, "/api/table-bookings").hasAnyAuthority("ROLE_ADMIN")
